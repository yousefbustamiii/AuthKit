...
from server.src.app.config.email_templates import BillingSubscriptionResumedTemplate
...
async def handle_subscription_resumed(pool: Pool, cache: Redis, data_obj: dict) -> None:
    ...
    template = BillingSubscriptionResumedTemplate(

...
from server.src.app.config.email_templates import BillingSubscriptionPausedTemplate
...
async def handle_subscription_paused(pool: Pool, cache: Redis, data_obj: dict) -> None:
    ...
    template = BillingSubscriptionPausedTemplate(
